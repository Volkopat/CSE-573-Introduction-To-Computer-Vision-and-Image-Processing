...
def detect_faces(input_path):
    result_list = []
    # absolute_path = "/Users/volkopat/opt/anaconda3/envs/ComputerVision/lib/python3.7/site-packages/cv2/data/" # Mac
    absolute_path = "C:/Users/ADMIN/anaconda3/envs/ai/Lib/site-packages/cv2/data/" # Windows
    image_path = input_path + '/*.jpg'
    for filename in glob.glob(os.path.normpath(image_path)):
